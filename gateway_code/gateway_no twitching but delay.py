...
SERIAL_BAUD         = 9600
SERIAL_CMD_INTERVAL = 0.10  # 10Hz -- slow enough to prevent buffer buildup
...
def main():
    ...
    while True:
        # 1) Receive latest command from HUD
        try:
        ...
        # 3) Send to Arduino at 10Hz -- prevents serial buffer buildup
